...
{{< figure src="/mrs-catfisher/franka picking up a bug.png" alt="Franka picking up a bug" width="80%">}}
...
{{< figure src="/mrs-catfisher/vision.jpeg" alt="Vision module" width="80%">}}
